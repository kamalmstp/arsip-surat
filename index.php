...
<html lang="en">
	<head>
		...
		<title> Dinas Sosial Kota Banjarmasin </title>
			...
			<div class="main_container">
				<div class="col-md-3 left_col">
					<div class="left_col scroll-view">
						<div class="navbar nav_title" style="border: 0;">
							<a href="index.php" class="site_title"><i class="fa fa-home"></i> Dinsos</a>
						</div>
				...
				// GET PAGE
					...
					*/
						...
						}elseif ($_GET['page']=="sekretaris") {
							include 'sekretaris.php';
						}elseif ($_GET['page']=="pdik") {
							include 'pdik.php';
						}elseif ($_GET['page']=="limjamsos") {
							include 'limjamsos.php';
						}elseif ($_GET['page']=="rehsos") {
							include 'rehsos.php';
				...
				<footer>
					...
					<strong>© 2019-2020.</strong> All right reserved
					</div>
					<div class="clearfix"></div>
				</footer>
				<!-- /footer content -->
