					...
					<div class="x_title">
						...
						<div class="bs-example-popovers">
							<div class="alert alert-success alert-dismissible fade-in" role="alert">
								<h2><strong>P.D & Informasi Kessos</strong></h2><br>
							</div>
						</div>
					<div class="x_content">
						<table id="disposisi" class="table table-striped table-bordered table-hover">
							...
							<tbody>
								<tr>
									<?php
										$no=1;
										$query2	= "SELECT * FROM disposisi JOIN surat_masuk ON disposisi.id_surat = surat_masuk.id where tujuan = 'pdik'";
									...
									<td>
										<center>
                                        <a href="cetak_pdik.php?id=<?php echo $row['id_disp']; ?>" class="btn btn-success" title="Print" type="submit" target="_blank" name="cetak"><i class="fa fa-print"></i></a>
										</center>
									</td>
								</tr>
									<?php 
