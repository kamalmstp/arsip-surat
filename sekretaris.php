	...
	<div class="">
		<div class="page-title">
			<div class="title_left">
				<h3>Data Disposisi Sekretaris</h3>
			</div>
		</div>
					...
					<div class="x_title">
						...
						<div class="bs-example-popovers">
							<div class="alert alert-success alert-dismissible fade-in" role="alert">
								<h2><strong>Sekretariat</strong></h2><br>
							</div>
						</div>
					<div class="x_content">
						<table id="disposisi" class="table table-striped table-bordered table-hover">
							...
							<tbody>
								<tr>
									<?php
										$no=1;
										$query2	= "SELECT * FROM disposisi JOIN surat_masuk ON disposisi.id_surat = surat_masuk.id where tujuan = 'sekretaris'";
